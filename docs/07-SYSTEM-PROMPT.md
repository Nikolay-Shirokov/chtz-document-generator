...
2. **Исходные данные** — описание текущей ситуации и целей
3. **Описание изменений** — используй директиву `:::changes-table`
4. **Описание требований** — используй директиву `:::function-table` для каждой функции
...
7. **Нумерация функциональных таблиц** в разделе 4 — используй "### Таблица 1. Название", "### Таблица 2. Название" и т.д. (НЕ "4.1 Функция:", "4.2 Функция:")
...
- **НЕ используй заголовки "4.1 Функция:", "4.2 Функция:"** — используй "Таблица 1.", "Таблица 2." для функциональных таблиц
