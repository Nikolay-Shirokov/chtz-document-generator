...
СТРУКТУРА ДОКУМЕНТА:
1. Термины, определения и сокращения (директива :::terms)
2. Исходные данные
3. Описание изменений (с таблицей :::changes-table)
4. Описание требований (с таблицами :::function-table)
...
Основные требования:
- Кнопка «Email-рассылка» в панели действий раздела «Клиенты»
