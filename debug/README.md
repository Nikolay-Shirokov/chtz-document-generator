...
Директория `reports/` игнорируется git (может содержать конфиденциальные данные).

Скрипты могут генерировать отчеты анализа в эту директорию:
- Полные отчеты о структуре вложенных таблиц
- Краткие сводки по результатам анализа
- Анализ raw XML структуры

**Важно:** Не коммитьте отчеты в репозиторий, если они содержат реальные данные из рабочих документов.
